...
const ALIASES: Record<string, string> = {
  ...
  // overland travel & the campaign map
  'map card': 'map-card',
  'map cards': 'map-card',
  'road card': 'road-card',
  'road cards': 'road-card',
  'town card': 'town-card',
  'town cards': 'town-card',
  'location card': 'location-card',
  'location cards': 'location-card',
  'plot card': 'plot-card',
  'plot cards': 'plot-card',
  'task card': 'task-card',
  'task cards': 'task-card',
  'traveling by river': 'traveling-by-river',
  'travel by river': 'traveling-by-river',
  'river travel': 'traveling-by-river',
  'time token': 'time-tokens',
  'time tokens': 'time-tokens',
  'nighttime quest': 'nighttime-quests',
  'nighttime quests': 'nighttime-quests',
  'tome of tales': 'tome-of-tales',
  finding: 'finding',
  findings: 'finding',
  services: 'services-in-settlements',
  trade: 'trade-in-settlements',
  // misc
  damage: 'damage',
  morale: 'morale',
  ally: 'ally',
